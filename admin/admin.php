...
<head>
    ...
    <title>Hotel Dheen - Admin</title>
</head>

<body>
    <!-- mobile view -->
    <div id="mobileview">
        <h5>Moblie View not supported for Admin Panel</h4>
    </div>
    ...
    <nav class="uppernav">
        ...
        <div class="logout">
        <a href="../logout.php"><button class="logbtn btn btn-primary">Logout</button></a>
        </div>
    </nav>
    <nav class="sidenav">
        <ul>
            <li class="pagebtn active"><img src="../image/icon/dashboard.png">&nbsp&nbsp&nbsp Dashboard</li>
            <li class="pagebtn"><img src="../image/icon/bed.png">&nbsp&nbsp&nbsp Room Booked</li>
