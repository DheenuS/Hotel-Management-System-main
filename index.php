...
<body>
    ...
    <section id="auth_section">
        ...
        <div class="logo">
            <img class="hotel_dheen_logo" src="./image/Hotel_Icon.png" alt="logo">
            <p>Wecome to Hotel Dheen</p>
        </div>
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <div class="form-floating">
                        <input typuser_logine="email" class="form-control" name="Email" placeholder=" " required>
                    ...
                    <div class="footer_line">
                        <h6>Don't have an account? <span class="page_move_btn" onclick="signuppage()">signup</span></h6>
                    </div>
                </form>
            ...
            <div id="sign_up">
                ...
                <form class="user_signup" id="usersignup" action="" method="POST">
                    ...
                    <div class="footer_line">
                        <h6>Already have an account? <span class="page_move_btn" onclick="loginpage()">Login</span></h6>
                    </div>
                </form>
            </div>
    </section>
